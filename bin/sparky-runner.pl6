...
)
{
  ...
  shell("sparrowdo --no_color --sparrow_root=/opt/sparky-sparrowdo/$project --task_run=directory" ~ '@path=' ~  "/var/data/sparky/$project --bootstrap --local_mode 1>$reports-root/$project.txt" ~ ' 2>&1');
